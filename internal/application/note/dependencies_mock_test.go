...
// Source: internal/application/note/dependencies.go
//
// Generated by this command:
//
//	mockgen -source=internal/application/note/dependencies.go -destination=internal/application/note/dependencies_mock_test.go -package=note_test
//
...
func (m *MockNoteRepository) Create(ctx context.Context, text string) (*entity.Note, error) {
	m.ctrl.T.Helper()
...
func (m *MockNoteRepository) List(ctx context.Context) ([]entity.Note, error) {
	m.ctrl.T.Helper()
