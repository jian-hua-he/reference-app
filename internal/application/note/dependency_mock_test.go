...
// Source: internal/application/note/dependency.go
//
// Generated by this command:
//
//	mockgen -source=internal/application/note/dependency.go -destination=internal/application/note/dependency_mock_test.go -package=note_test
//
